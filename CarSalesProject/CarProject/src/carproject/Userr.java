...
public class Userr extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Search by cost:");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
      ...
      String model = rs.getString("MODEL");
      double cost = rs.getDouble("cost");
      c.jTextField1.setText(manufacturer);
      c.jTextField2.setText(model);
      c.jTextField3.setText(String.valueOf(cost));
       }
       catch(SQLException e)
        {
        System.out.println(e.getMessage());
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
           try{
        double search_cost = Double.parseDouble(jTextField6.getText());
        int found = 0;
        rs.absolute(0); // بتجيبلك الرو اللي انت عايزة رقمه
        while(rs.next()){
        if(search_cost == rs.getDouble(5)){
            found = 1;
        jTextField1.setText(rs.getString(1));
        jTextField2.setText(rs.getString(2)); 
        jTextField3.setText(rs.getString(3));
        jTextField4.setText(rs.getLong(4)+"");
